package gremsReliquary.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import gremsReliquary.cards.AbstractDefaultCard;

import static gremsReliquary.GremsReliquary.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "gremsReliquary:" (or, your id) before the name.
    }
